        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <p className="text-xs text-gray-600 mt-1">Tap to select (max 5 images)</p>
            </label>
            <input
              id="image-input"
              type="file"
          ...
          {form.imagePreviews.length > 0 && (
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <p className="font-bold text-gray-900">Selected Photos</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                {form.imagePreviews.map((preview, index) => (
                  <div
                    key={index}
                    className="relative group aspect-square rounded-xl overflow-hidden bg-gray-100 border-2 border-gray-200 hover:border-lime-400 transition shadow-sm hover:shadow-md"
                  >
                    <Image
                      src={preview}
                      alt={`Preview ${index + 1}`}
                    ...
                    <div className="absolute bottom-2 left-2 bg-black/70 text-white text-xs font-bold px-2 py-1 rounded-lg backdrop-blur-sm">
                      #{index + 1}
                    </div>
                  </div>
                ))}
