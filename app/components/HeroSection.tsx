  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] overflow-hidden bg-black flex items-center justify-center font-outfit pt-24 md:pt-[136px]">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Desktop Layout: Split-screen Dual Slide */}
        <div className="hidden lg:grid grid-cols-2 absolute inset-0">
      ...
      {/* Action Button positioned at the bottom above the scroll text */}
      <div className="absolute bottom-28 md:bottom-32 left-1/2 -translate-x-1/2 z-30 w-full max-w-4xl px-6 text-center">
        <motion.div
        ...
        >
          <Link
            ...
            className="group relative px-8 md:px-14 py-4 md:py-6 bg-lime-500 hover:bg-lime-400 text-slate-950 font-black rounded-2xl overflow-hidden transition-all duration-500 shadow-[0_20px_50px_rgba(132,204,22,0.4)] hover:shadow-[0_30px_70px_rgba(132,204,22,0.6)] flex items-center justify-center gap-3 active:scale-95 text-xs md:text-base tracking-widest uppercase"
          >
            <span className="relative z-10">Shop 2026 Costume Collections</span>
      ...
      <div className={`absolute bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-30 transition-all duration-1000 delay-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
        <div className="flex flex-col items-center gap-2">
          <span className="text-[9px] uppercase font-black tracking-[0.5em] text-gray-500">Scroll</span>
          <div className="w-[1.5px] h-8 bg-gradient-to-b from-lime-500 to-transparent rounded-full" />
        </div>
      </div>
    </section>
  );
