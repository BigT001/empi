    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-700 p-6 flex items-center justify-between text-white">
          <div>
            <h2 className="text-2xl font-bold">🎭 Rental Schedule</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white font-medium"
            />
            <p className="text-xs text-gray-600 mt-2">Store hours: 9:00 AM - 6:00 PM</p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="px-4 py-3 bg-gray-200 hover:bg-gray-300 rounded-lg font-bold text-gray-900 transition"
              >
                −
              </button>
              <div className="flex-1">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white font-bold text-center text-lg"
                />
              </div>
              <button
                onClick={() => setRentalDays(rentalDays + 1)}
                className="px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-bold transition"
              >
                +
              </button>
            </div>
          ...
          {returnDate && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <p className="text-xs text-green-600 mt-2">Next day after your last use</p>
            </div>
          )}
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-900">{PICKUP_LOCATION.name}</h4>
                <p className="text-sm text-gray-600 mt-1">{PICKUP_LOCATION.address}</p>
                <p className="text-sm text-gray-600 mt-1">⏰ {PICKUP_LOCATION.hours}</p>
              </div>
            </div>
          </div>
          ...
          {pickupDate && (
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200">
              <h4 className="font-semibold text-gray-900 mb-3">📋 Your Rental Schedule</h4>
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-200">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition flex items-center justify-center gap-2"
            >
